...
export function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-16 md:py-24 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="inline-flex items-center px-3 sm:px-6 py-2 sm:py-3 rounded-full bg-orange-500/20 border border-orange-500/30 mb-4 sm:mb-8 backdrop-blur-sm glow-effect"
          >
          ...
          <motion.h1
            ...
            className="text-2xl sm:text-4xl md:text-5xl lg:text-7xl text-white font-bold mb-3 sm:mb-6 font-[family-name:var(--font-space-grotesk)] text-balance leading-[1.1] sm:leading-tight"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-8 max-w-4xl mx-auto text-pretty font-[family-name:var(--font-dm-sans)] leading-relaxed px-2 sm:px-0"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-6 sm:mb-12 px-4 sm:px-0"
          >
            <AnimatedButton
              variant="primary"
